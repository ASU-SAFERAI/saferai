# Reference:
# https://github.com/stanford-crfm/helm/blob/fc2baa6b3be42f5e46e9ef70b2cc7f2e25f0a977/src/helm/benchmark/augmentations/misspelling_perturbation.py
...
CORRECT_TOMISSPELLING_MAPPING_FILE_PATH = "perturbation/data/correct_to_misspelling.json"
...
class MisspellingPerturbation(TextPerturbation):
    ...
    **Output:**
    ...
    def __init__(self, prob: float):
        ...
        self.correct_to_misspelling: Dict[str, List[str]] = {}
        with open(CORRECT_TOMISSPELLING_MAPPING_FILE_PATH) as f:
