...
from .scenario import Input, Instance, Reference, Output
from .utils import match_case
from .perturbation_description import PerturbationDescription
from .perturbation_base import Perturbation

PERSON_NAME_FILE_PATH = 'perturbation/data/person_names.txt'
...
class PersonNamePerturbation(Perturbation):
    ...
    def __init__(
        ...
        name_file_path: Optional[str] = PERSON_NAME_FILE_PATH,
